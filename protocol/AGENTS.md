...
- Put filled Runtime Kit examples in `docs/examples/`; use evidence fill, model discovery, and independent review examples to reduce onboarding friction before adding more empty template fields.
