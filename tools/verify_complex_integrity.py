...
def main() -> None:
    ...
    check(checks, "behavior_case_count_11", len(case_ids) == 11, sorted(case_ids))
    check(checks, "required_case_count_11", len(required_ids) == 11, sorted(required_ids))
    check(checks, "transcript_rule_count_11", len(rule_ids) == 11, sorted(rule_ids))
